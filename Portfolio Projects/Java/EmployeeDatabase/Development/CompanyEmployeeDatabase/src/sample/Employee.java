/**
 * This class represents an employee within an orginisation
 *
...
public class Employee implements Comparable<Employee>
{
    ...
    private int payPA; 
    private String[] roleAndDepartment = new String[2];
    ...
    public void setNationalInsuranceNumber(String nationalInsuranceNumber)
    {
        ...
        System.out.println("Warning, altering the NI for this employee will massivily alter them."
     ...
     * 
     * As this is a static number that increments with each new employee added to the database, added comfirmation.
     * If the new number is higher than the current highest employee then the static value is changed to reflect this.
     * 
     * Idealy, this would not be changed.
     * 
     ...
     * 
     * I did consider making these seperate, but decided it was better to have it combined.
     * If one or more values are null then the corisponding value doesn't change.
     * 
     ...
     * Defines equality as equal National Insurance Number.
     * Uses Strings equal method to check String equality.
     * @param obj the Object to check equality with
     * @return If this object and the supplied object are equal
     */
    @Override
     ...
     * After that I concactanate them into a string and parse that to an int. I think this will always result in a unique
    ...
    public int hashCode()
    {
        String newHashString = ""; // Temp hashCode while concatanating.
    ...
    .collect(Collectors.toList());
        // Concactanate hash code using each char value in NI
        for(int num : elements) {
            newHashString += num;
        }
        return Integer.parseInt(newHashString); // Convert to int and return
    }
    ...
    public int compareTo(Employee obj)
    {
        ...
        {   // lineManager is the same, so sort by vin
            ...
            return getLineManager().compareTo(obj.getLineManager()); // Uses Strings compareTo method to sort alphbeticaly *** SPELLCHECK
        }
    }
}
